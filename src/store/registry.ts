...
const mixifierHtmlFilesContext = require.context(
	`../mixifier/`,
	true,
	/\.html$/,
);
const rawHtmlFilesContext = require.context(
	'!!raw-loader!../../src/',
	true,
	/.*.html$/,
);
const rawVueFilesContext = require.context(
	'!!raw-loader!../../src/',
	true,
	/.*.vue$/,
);
...
const vueComponents: any = vueComponentsContext
	.keys()
	.map(vueComponentsContext);
...
function buildComponentsMap() {
	const styleGuideComponentsContext = require.context(
